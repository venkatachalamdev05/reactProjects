                                ...
                                <div className="solution_cards_box">
                                    <div className="solution_card2">
                                        ...
                                        <div className="solu_description">
                                            <form>
                                                <input type="text" placeholder="Enter Your Name" onChange={(event) => setName(event.target.value)} className="form-control" required/><br /><br />
                                                <input type="number" placeholder="Enter Your Phone Number" onChange={(event) => setNumber(event.target.value)} className="form-control" required/><br /><br />
                                                <input type="text" placeholder="Enter Your Mail Id" onChange={(event) => setMail(event.target.value)} className="form-control" required /><br /><br />
                                                <button onClick={navigateToAddData} className="read_more_btn" disabled={!name && !number && !mail} >Save Contacts</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
